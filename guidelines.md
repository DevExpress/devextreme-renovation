...
Если вы используете метод, работающий с CSS-стилями, следует использовать тип `CSSStyles`. Этот тип корректно обрабатывается генераторами в различных фреймворках и упрощает типизацию.
