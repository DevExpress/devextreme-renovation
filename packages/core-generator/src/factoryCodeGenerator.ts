...
export function generateFactoryCode(
    ...
    switch (node.kind) {
      ...
      case ts.SyntaxKind.RegularExpressionLiteral:
        createRegularExpressionLiteral(
          node as import('typescript').RegularExpressionLiteral,
        );
        return;
      ...
      case ts.SyntaxKind.ComputedPropertyName:
        createComputedPropertyName(
          node as import('typescript').ComputedPropertyName,
        );
        return;
      case ts.SyntaxKind.TypeParameter:
        createTypeParameterDeclaration(
          node as import('typescript').TypeParameterDeclaration,
        );
        return;
      ...
      case ts.SyntaxKind.CallSignature:
        createCallSignature(
          node as import('typescript').CallSignatureDeclaration,
        );
        return;
      case ts.SyntaxKind.ConstructSignature:
        createConstructSignature(
          node as import('typescript').ConstructSignatureDeclaration,
        );
        return;
      case ts.SyntaxKind.IndexSignature:
        createIndexSignature(
          node as import('typescript').IndexSignatureDeclaration,
        );
        return;
      ...
      case ts.SyntaxKind.TypePredicate:
        createTypePredicateNodeWithModifier(
          node as import('typescript').TypePredicateNode,
        );
        return;
      ...
      case ts.SyntaxKind.ConstructorType:
        createConstructorTypeNode(
          node as import('typescript').ConstructorTypeNode,
        );
        return;
      ...
      case ts.SyntaxKind.IntersectionType:
        createIntersectionTypeNode(
          node as import('typescript').IntersectionTypeNode,
        );
        return;
      case ts.SyntaxKind.ConditionalType:
        createConditionalTypeNode(
          node as import('typescript').ConditionalTypeNode,
        );
        return;
      ...
      case ts.SyntaxKind.ParenthesizedType:
        createParenthesizedType(
          node as import('typescript').ParenthesizedTypeNode,
        );
        return;
      ...
      case ts.SyntaxKind.IndexedAccessType:
        createIndexedAccessTypeNode(
          node as import('typescript').IndexedAccessTypeNode,
        );
        return;
      ...
      case ts.SyntaxKind.ObjectBindingPattern:
        createObjectBindingPattern(
          node as import('typescript').ObjectBindingPattern,
        );
        return;
      case ts.SyntaxKind.ArrayBindingPattern:
        createArrayBindingPattern(
          node as import('typescript').ArrayBindingPattern,
        );
        return;
      ...
      case ts.SyntaxKind.ObjectLiteralExpression:
        createObjectLiteral(
          node as import('typescript').ObjectLiteralExpression,
        );
        return;
      case ts.SyntaxKind.PropertyAccessExpression:
        if (ts.isPropertyAccessChain(node)) {
          createPropertyAccessChain(
            node as import('typescript').PropertyAccessChain,
          );
          return;
        }
        if (ts.isPropertyAccessExpression(node)) {
          createPropertyAccess(
            node as import('typescript').PropertyAccessExpression,
          );
          return;
        }
      ...
      case ts.SyntaxKind.ElementAccessExpression:
        if (ts.isElementAccessChain(node)) {
          createElementAccessChain(
            node as import('typescript').ElementAccessChain,
          );
          return;
        }
        if (ts.isElementAccessExpression(node)) {
          createElementAccess(
            node as import('typescript').ElementAccessExpression,
          );
          return;
        }
        throw new Error(`Unhandled node: ${node.getText()}`);
      ...
      case ts.SyntaxKind.TaggedTemplateExpression:
        createTaggedTemplate(
          node as import('typescript').TaggedTemplateExpression,
        );
        return;
      ...
      case ts.SyntaxKind.FunctionExpression:
        createFunctionExpression(
          node as import('typescript').FunctionExpression,
        );
        return;
      ...
      case ts.SyntaxKind.TemplateExpression:
        createTemplateExpression(
          node as import('typescript').TemplateExpression,
        );
        return;
      ...
      case ts.SyntaxKind.NoSubstitutionTemplateLiteral:
        createNoSubstitutionTemplateLiteral(
          node as import('typescript').NoSubstitutionTemplateLiteral,
        );
        return;
      ...
      case ts.SyntaxKind.ExpressionWithTypeArguments:
        createExpressionWithTypeArguments(
          node as import('typescript').ExpressionWithTypeArguments,
        );
        return;
      ...
      case ts.SyntaxKind.ExpressionStatement:
        createExpressionStatement(
          node as import('typescript').ExpressionStatement,
        );
        return;
      ...
      case ts.SyntaxKind.VariableDeclaration:
        createVariableDeclaration(
          node as import('typescript').VariableDeclaration,
        );
        return;
      case ts.SyntaxKind.VariableDeclarationList:
        createVariableDeclarationList(
          node as import('typescript').VariableDeclarationList,
        );
        return;
      case ts.SyntaxKind.FunctionDeclaration:
        createFunctionDeclaration(
          node as import('typescript').FunctionDeclaration,
        );
        return;
      ...
      case ts.SyntaxKind.InterfaceDeclaration:
        createInterfaceDeclaration(
          node as import('typescript').InterfaceDeclaration,
        );
        return;
      case ts.SyntaxKind.TypeAliasDeclaration:
        createTypeAliasDeclaration(
          node as import('typescript').TypeAliasDeclaration,
        );
        return;
      ...
      case ts.SyntaxKind.NamespaceExportDeclaration:
        createNamespaceExportDeclaration(
          node as import('typescript').NamespaceExportDeclaration,
        );
        return;
      case ts.SyntaxKind.ImportEqualsDeclaration:
        createImportEqualsDeclaration(
          node as import('typescript').ImportEqualsDeclaration,
        );
        return;
      ...
      case ts.SyntaxKind.ExternalModuleReference:
        createExternalModuleReference(
          node as import('typescript').ExternalModuleReference,
        );
        return;
      ...
      case ts.SyntaxKind.JsxSelfClosingElement:
        createJsxSelfClosingElement(
          node as import('typescript').JsxSelfClosingElement,
        );
        return;
      ...
      case ts.SyntaxKind.JsxSpreadAttribute:
        createJsxSpreadAttribute(
          node as import('typescript').JsxSpreadAttribute,
        );
        return;
      ...
      case ts.SyntaxKind.PropertyAssignment:
        createPropertyAssignment(
          node as import('typescript').PropertyAssignment,
        );
        return;
      case ts.SyntaxKind.ShorthandPropertyAssignment:
        createShorthandPropertyAssignment(
          node as import('typescript').ShorthandPropertyAssignment,
        );
        return;
      ...
      default:
        if (
          ...
          writer
            .write('ts.createToken(ts.SyntaxKind.')
            .write(syntaxKindToName[node.kind])
            .write(')');
          return;
        }
        writer
          .write('/* Unhandled node kind: ')
          .write(syntaxKindToName[node.kind])
          .write(' */');
    }
  }
  ...
  function createRegularExpressionLiteral(
    node: import('typescript').RegularExpressionLiteral,
  ) {
  ...
  function createComputedPropertyName(
    node: import('typescript').ComputedPropertyName,
  ) {
  ...
  function createTypeParameterDeclaration(
    node: import('typescript').TypeParameterDeclaration,
  ) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.constraint == null) writer.write('undefined');
      else {
        writeNodeText(node.constraint);
      }
      writer.write(',').newLine();
      if (node.default == null) writer.write('undefined');
      else {
  ...
  function createParameter(node: import('typescript').ParameterDeclaration) {
    ...
    writer.newLine();
    writer.indent(() => {
      if (node.decorators == null) writer.write('undefined');
      else {
        writer.write('[');
      ...
      writer.write(',').newLine();
      if (node.modifiers == null) writer.write('undefined');
      else {
        writer.write('[');
        if (node.modifiers.length === 1) {
          const item = node.modifiers![0];
          writer.write(
            `ts.createModifier(ts.SyntaxKind.${
              syntaxKindToName[item.kind]
            })`,
          );
      ...
      writer.write(',').newLine();
      if (node.dotDotDotToken == null) writer.write('undefined');
      else {
      ...
      writeNodeText(node.name);
      writer.write(',').newLine();
      if (node.questionToken == null) writer.write('undefined');
      else {
        writeNodeText(node.questionToken);
      }
      writer.write(',').newLine();
      if (node.type == null) writer.write('undefined');
      else {
        writeNodeText(node.type);
      }
      writer.write(',').newLine();
      if (node.initializer == null) writer.write('undefined');
      else {
  ...
  function createPropertySignature(
    node: import('typescript').PropertySignature,
  ) {
  ...
  function createProperty(node: import('typescript').PropertyDeclaration) {
    ...
    writer.indent(() => {
      ...
      writeNodeText(node.name);
      writer.write(',').newLine();
      if (node.questionToken != null) { writer.write('ts.createToken(ts.SyntaxKind.QuestionToken)'); } else if (node.exclamationToken != null) { writer.write('ts.createToken(ts.SyntaxKind.ExclamationToken)'); } else writer.write('undefined');
      writer.write(',').newLine();
      if (node.type == null) writer.write('undefined');
      else {
        writeNodeText(node.type);
  ...
  function createMethodSignature(node: import('typescript').MethodSignature) {
    ...
    writer.newLine();
    writer.indent(() => {
      if (node.typeParameters == null) writer.write('undefined');
      else {
        writer.write('[');
  ...
  function createMethod(node: import('typescript').MethodDeclaration) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.asteriskToken == null) writer.write('undefined');
      else {
      ...
      writer.write(',').newLine();
      if (node.body == null) writer.write('undefined');
      else {
  ...
  function createConstructor(
    node: import('typescript').ConstructorDeclaration,
  ) {
  ...
  function createSetAccessor(
    node: import('typescript').SetAccessorDeclaration,
  ) {
  ...
  function createCallSignature(
    node: import('typescript').CallSignatureDeclaration,
  ) {
  ...
  function createConstructSignature(
    node: import('typescript').ConstructSignatureDeclaration,
  ) {
  ...
  function createIndexSignature(
    node: import('typescript').IndexSignatureDeclaration,
  ) {
  ...
  function createTypePredicateNodeWithModifier(
    node: import('typescript').TypePredicateNode,
  ) {
    writer.write('ts.createTypePredicateNodeWithModifier(');
    writer.newLine();
    writer.indent(() => {
      if (node.assertsModifier == null) writer.write('undefined');
      else {
  ...
  function createTypeReferenceNode(
    node: import('typescript').TypeReferenceNode,
  ) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.typeArguments == null) writer.write('undefined');
      else {
        writer.write('[');
  ...
  function createConstructorTypeNode(
    node: import('typescript').ConstructorTypeNode,
  ) {
  ...
  function createIntersectionTypeNode(
    node: import('typescript').IntersectionTypeNode,
  ) {
  ...
  function createConditionalTypeNode(
    node: import('typescript').ConditionalTypeNode,
  ) {
  ...
  function createImportTypeNode(node: import('typescript').ImportTypeNode) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.qualifier == null) writer.write('undefined');
      else {
      ...
      writer.write(',').newLine();
      if (node.isTypeOf == null) writer.write('undefined');
      else {
  ...
  function createParenthesizedType(
    node: import('typescript').ParenthesizedTypeNode,
  ) {
  ...
  function createIndexedAccessTypeNode(
    node: import('typescript').IndexedAccessTypeNode,
  ) {
  ...
  function createMappedTypeNode(node: import('typescript').MappedTypeNode) {
    ...
    writer.newLine();
    writer.indent(() => {
      if (node.readonlyToken == null) writer.write('undefined');
      else {
  ...
  function createObjectBindingPattern(
    node: import('typescript').ObjectBindingPattern,
  ) {
  ...
  function createArrayBindingPattern(
    node: import('typescript').ArrayBindingPattern,
  ) {
  ...
  function createBindingElement(node: import('typescript').BindingElement) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.propertyName == null) writer.write('undefined');
      else {
  ...
  function createArrayLiteral(
    node: import('typescript').ArrayLiteralExpression,
  ) {
  ...
  function createPropertyAccessChain(
    node: import('typescript').PropertyAccessChain,
  ) {
    ...
    writer.indent(() => {
      writeNodeText(node.expression);
      writer.write(',').newLine();
      if (node.questionDotToken == null) writer.write('undefined');
      else {
  ...
  function createElementAccess(
    node: import('typescript').ElementAccessExpression,
  ) {
  ...
  function createElementAccessChain(
    node: import('typescript').ElementAccessChain,
  ) {
  ...
  function createNew(node: import('typescript').NewExpression) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.arguments == null) writer.write('undefined');
      else {
        writer.write('[');
        if (node.arguments.length === 1) {
          const item = node.arguments![0];
  ...
  function createFunctionExpression(
    node: import('typescript').FunctionExpression,
  ) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.name == null) writer.write('undefined');
      else {
        writeNodeText(node.name);
      }
      writer.write(',').newLine();
  ...
  function createTemplateHead(node: import('typescript').TemplateHead) {
    ...
    writer.indent(() => {
      writer.quote(node.text.toString());
      writer.write(',').newLine();
      if (node.rawText == null) writer.write('undefined');
      else {
  ...
  function createNoSubstitutionTemplateLiteral(
    node: import('typescript').NoSubstitutionTemplateLiteral,
  ) {
  ...
  function createYield(node: import('typescript').YieldExpression) {
    ...
    if (node.expression == null) writer.write('undefined');
    else {
      writeNodeText(node.expression);
    }
    writer.write(')');
  ...
  function createClassExpression(node: import('typescript').ClassExpression) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.heritageClauses == null) writer.write('undefined');
      else {
        writer.write('[');
  ...
  function createExpressionWithTypeArguments(
    node: import('typescript').ExpressionWithTypeArguments,
  ) {
  ...
  function createNonNullExpression(
    node: import('typescript').NonNullExpression,
  ) {
  ...
  function createIf(node: import('typescript').IfStatement) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.elseStatement == null) writer.write('undefined');
      else {
  ...
  function createFor(node: import('typescript').ForStatement) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.condition == null) writer.write('undefined');
      else {
        writeNodeText(node.condition);
      }
      writer.write(',').newLine();
      if (node.incrementor == null) writer.write('undefined');
      else {
  ...
  function createForOf(node: import('typescript').ForOfStatement) {
    ...
    writer.newLine();
    writer.indent(() => {
      if (node.awaitModifier == null) writer.write('undefined');
      else {
  ...
  function createContinue(node: import('typescript').ContinueStatement) {
    ...
    if (node.label == null) writer.write('undefined');
    else {
  ...
  function createTry(node: import('typescript').TryStatement) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.catchClause == null) writer.write('undefined');
      else {
        writeNodeText(node.catchClause);
      }
      writer.write(',').newLine();
      if (node.finallyBlock == null) writer.write('undefined');
      else {
  ...
  function createVariableDeclarationList(
    node: import('typescript').VariableDeclarationList,
  ) {
  ...
  function createModuleDeclaration(
    node: import('typescript').ModuleDeclaration,
  ) {
  ...
  function createNamespaceExportDeclaration(
    node: import('typescript').NamespaceExportDeclaration,
  ) {
  ...
  function createImportEqualsDeclaration(
    node: import('typescript').ImportEqualsDeclaration,
  ) {
  ...
  function createImportDeclaration(
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.importClause == null) writer.write('undefined');
      else {
  ...
  function createImportClause(node: import('typescript').ImportClause) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.namedBindings == null) writer.write('undefined');
      else {
  ...
  function createExportAssignment(node: import('typescript').ExportAssignment) {
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.isExportEquals == null) writer.write('undefined');
      else {
  ...
  function createExportDeclaration(
    ...
    writer.indent(() => {
      ...
      writer.write(',').newLine();
      if (node.exportClause == null) writer.write('undefined');
      else {
        writeNodeText(node.exportClause);
      }
      writer.write(',').newLine();
      if (node.moduleSpecifier == null) writer.write('undefined');
      else {
        writeNodeText(node.moduleSpecifier);
      }
    });
  ...
  function createExternalModuleReference(
    node: import('typescript').ExternalModuleReference,
  ) {
  ...
  function createJsxOpeningElement(
    node: import('typescript').JsxOpeningElement,
  ) {
  ...
  function createJsxClosingElement(
    node: import('typescript').JsxClosingElement,
  ) {
  ...
  function createJsxSpreadAttribute(
    node: import('typescript').JsxSpreadAttribute,
  ) {
  ...
  function createCatchClause(node: import('typescript').CatchClause) {
    ...
    writer.newLine();
    writer.indent(() => {
      if (node.variableDeclaration == null) writer.write('undefined');
      else {
  ...
  function createPropertyAssignment(
    node: import('typescript').PropertyAssignment,
  ) {
  ...
  function createShorthandPropertyAssignment(
    node: import('typescript').ShorthandPropertyAssignment,
  ) {
    ...
    writer.indent(() => {
      writeNodeText(node.name);
      writer.write(',').newLine();
      if (node.objectAssignmentInitializer == null) writer.write('undefined');
      else {
  ...
  function createSyntaxKindToNameMap() {
    ...
    for (const name of Object.keys(ts.SyntaxKind).filter((k) => isNaN(parseInt(k, 10)))) {
      ...
      if (map[value] == null) map[value] = name;
    }
    return map;
  }
  ...
  function getNodeFlagValues(value: number) {
    ...
    return getFlagValuesAsString(
      ts.NodeFlags,
      'ts.NodeFlags',
      value || 0,
      'None',
      getFlagValues(ts.NodeFlags, value).filter(
        (v) => v !== ts.NodeFlags.BlockScoped,
      ),
    );
  }

  function getFlagValuesAsString(
    enumObj: any,
    enumName: string,
    value: number,
    defaultName: string,
    ...
    for (const flagValue of flagValues) { members.push(`${enumName}.${enumObj[flagValue]}`); }
    if (members.length === 0) members.push(`${enumName}.${defaultName}`);
    return members.join(' | ');
  }
