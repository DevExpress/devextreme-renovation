...
function ReactModelWidget(props: typeof ModelWidgetInput & RestProps) {
...
HooksModelWidget.defaultProps = ModelWidgetInput;

function HooksModelWidget(props: typeof ModelWidgetInput & RestProps) {
  return <HookContainer renderFn={ReactModelWidget} renderProps={props} />;
}
export { HooksModelWidget as ModelWidget };
export default HooksModelWidget;
