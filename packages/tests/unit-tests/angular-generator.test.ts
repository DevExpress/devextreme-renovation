  ...
  mocha.describe("JSX -> AngularTemplate", function () {
    ...
    mocha.it("Pass svg children into component", function () {
      ...
      assert.strictEqual(
        removeSpaces(expression.toString()),
        removeSpaces(`
          <dx-base-widget #basewidget1 styles="{display:contents}"  ><svg:text ></text></dx-base-widget>
    ...
    mocha.describe("Component", function () {
      mocha.it("Render himself", function () {
        ...
        assert.strictEqual(
          ...
          removeSpaces(`
            <dx-base-widget #basewidget1 styles="{display:contents}"  ></dx-base-widget>
            <ng-content *ngTemplateOutlet="basewidget1?.widgetTemplate"></ng-content>
          `)
        );
      });
    ...
    mocha.describe("Spread attribute on component", function () {
      ...
      mocha.it("...props - pick only props those exist in widget", function () {
        ...
        assert.strictEqual(
          ...
          removeSpaces(`
            <dx-base-widget #basewidget1 styles="{display:contents}"  [p1]="p1"></dx-base-widget>
            <ng-content*ngTemplateOutlet="basewidget1?.widgetTemplate"></ng-content>
          `)
        );
      });
      ...
      mocha.it("...props, method - pick method", function () {
        ...
        assert.strictEqual(
          ...
          removeSpaces(`
            <dx-base-widget #basewidget1 styles="{display:contents}"  [p1]="__p1"></dx-base-widget>
            <ng-content*ngTemplateOutlet="basewidget1?.widgetTemplate"></ng-content>
          `)
        );
      });
      ...
      mocha.it(
        ...
        function () {
          ...
          assert.strictEqual(
            ...
            removeSpaces(`
              <dx-base-widget #basewidget1 styles="{display:contents}"  [p1]="(p1!==undefined?p1:__p1)"></dx-base-widget>
              <ng-content*ngTemplateOutlet="basewidget1?.widgetTemplate"></ng-content>
            `)
          );
        }
      ...
      mocha.it("...props, getter - pick props,getter", function () {
        ...
        assert.strictEqual(
          ...
          removeSpaces(`
            <dx-base-widget #basewidget1 styles="{display:contents}"  [p1]="(__p1!==undefined?__p1:p1)"></dx-base-widget>
            <ng-content*ngTemplateOutlet="basewidget1?.widgetTemplate"></ng-content>
          `)
        );
      });
      ...
      mocha.it("...{x: x, y}", function () {
        ...
        assert.strictEqual(
          ...
          removeSpaces(`
            <dx-base-widget #basewidget1 styles="{display:contents}"  [x]="xValue" [y]="y"></dx-base-widget>
            <ng-content*ngTemplateOutlet="basewidget1?.widgetTemplate"></ng-content>
          `)
        );
      });
      ...
      mocha.describe("Import widget.", function () {
        ...
        mocha.it("<Widget></Widget> -> <dx-widget></dx-widget>", function () {
          ...
          assert.strictEqual(removeSpaces(element.toString()), removeSpaces(`
            <dx-widget #widget1 styles="{display:contents}" ></dx-widget>
        ...
        mocha.it("Event attribute should be wrapped in paren", function () {
          ...
          assert.strictEqual(
            ...
            removeSpaces(`<dx-widget (event)="value($event)" #widget1 styles="{display:contents}" ></dx-widget>
            <ng-content *ngTemplateOutlet="widget1?.widgetTemplate"></ng-content>`)
          );
        });
        ...
        mocha.it("className should not be renamed to class", function () {
          ...
          assert.strictEqual(
            ...
            removeSpaces(`<dx-widget [className]="value" #widget1 styles="{display:contents}" ></dx-widget>
            <ng-content *ngTemplateOutlet="widget1?.widgetTemplate"></ng-content>`)
          );
        });
        ...
        mocha.it(
          ...
          function () {
            ...
            assert.strictEqual(
              ...
              removeSpaces(`<dx-widget [className]="value" #widget1 styles="{display:contents}" >
        ...
        mocha.describe("Pass slots via attribute", function () {
          ...
          mocha.it("Self-closing element", function () {
            ...
            assert.strictEqual(
              ...
              removeSpaces(`
              <dx-widget #widget1 styles="{display:contents}" >
                <div #slotChildren style="display: contents">
                  <ng-container [ngTemplateOutlet]="dxchildren"></ng-container>
                </div>
              </dx-widget>
      ...
      mocha.describe("function->ng-template", function () {
        ...
        mocha.it("w/o parameter", function () {
          ...
          assert.strictEqual(
            ...
            removeSpaces(`
              <dx-base-widget [template]="__template__generated" #basewidget1 styles="{display:contents}"  >
                <ng-template #__template__generated>
                  <div ></div>
                </ng-template>
              </dx-base-widget>
  ...
  mocha.describe("ComponentBindings", function () {
    ...
    mocha.it("Do not include inherited props", function () {
      ...
      assert.strictEqual(
        ...
        getResult("export default class Child extends Base {}")
      );
    });
