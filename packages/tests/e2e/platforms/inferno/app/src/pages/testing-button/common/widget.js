...
exports.InfernoWidgetFR = exports.WidgetProps = exports.viewFunction = exports.ConfigContext = void 0;
...
var getAria = function (args) { return Object.keys(args).reduce(function (r, key) {
    var _a;
    if (args[key]) {
        return __assign(__assign({}, r), (_a = {}, _a[key === 'role' || key === 'id' ? key : "aria-".concat(key)] = String(args[key]), _a));
    }
    return r;
}, {}); };
exports.ConfigContext = (0, create_context_1.createContext)(undefined);
var viewFunction = function (viewModel) {
    var widget = (<div ref={viewModel.widgetElementRef} {...viewModel.attributes} tabIndex={viewModel.tabIndex} title={viewModel.props.hint} hidden={!viewModel.props.visible} className={viewModel.cssClasses} style={normalizeStyles(viewModel.styles)} onClick={viewModel.props.onClick} onKeyDown={viewModel.props.onKeyDown}>
...
var getNumberStyleValue = function (style, value) { return (NUMBER_STYLES.has(style) ? value : "".concat(value, "px")); };
...
var Widget = function (ref) { return function (props) {
    var __widgetElementRef = (0, hooks_1.useRef)(null);
    var _a = (0, hooks_1.useState)(false), __state_active = _a[0], __state_setActive = _a[1];
    var _b = (0, hooks_1.useState)(false), __state_focused = _b[0], __state_setFocused = _b[1];
    var _c = (0, hooks_1.useState)(false), __state_hovered = _c[0], __state_setHovered = _c[1];
    var config = (0, hooks_1.useContext)(exports.ConfigContext);
    var __shouldRenderConfigProvider = (0, hooks_1.useCallback)(function () {
        var rtlEnabled = props.rtlEnabled;
        return (0, resolve_rtl_1.resolveRtlEnabledDefinition)(rtlEnabled, config);
    }, [props.rtlEnabled, config]);
    var __rtlEnabled = (0, hooks_1.useCallback)(function () {
        var rtlEnabled = props.rtlEnabled;
        return (0, resolve_rtl_1.resolveRtlEnabled)(rtlEnabled, config);
    }, [props.rtlEnabled, config]);
    var __tabIndex = (0, hooks_1.useCallback)(function () {
    ...
    var __blur = (0, hooks_1.useCallback)(function () {
    ...
    var __attributes = (0, hooks_1.useCallback)(function () {
        ...
        return __assign(__assign({}, (0, extend_1.extend)({}, __restAttributes(), accessKey && { accessKey: accessKey })), getAria(__assign(__assign({}, aria), { disabled: disabled, hidden: !visible })));
    }, [
        props.aria,
        props.disabled,
    ...
    var __styles = (0, hooks_1.useCallback)(function () {
        var height = props.height, width = props.width;
        var style = __restAttributes().style || {};
        var computedWidth = (0, style_1.normalizeStyleProp)('width', (0, type_1.isFunction)(width) ? width() : width);
        var computedHeight = (0, style_1.normalizeStyleProp)('height', (0, type_1.isFunction)(height) ? height() : height);
    ...
    var __cssClasses = (0, hooks_1.useCallback)(function () {
        var _a;
    ...
    (0, hooks_1.useEffect)(function () {
        var height = props.height, width = props.width;
        if ((0, type_1.isFunction)(width)) {
            errors_1["default"].log('W0017', 'width');
        }
        if ((0, type_1.isFunction)(height)) {
...
function InfernoWidget(props, ref) {
    return <hooks_1.HookComponent renderFn={WidgetFn(ref)} renderProps={props}></hooks_1.HookComponent>;
}
var InfernoWidgetFR = (0, inferno_1.forwardRef)(InfernoWidget);
