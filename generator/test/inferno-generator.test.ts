  ...
  mocha.describe("ImportDeclaration", function () {
    ...
    mocha.it(
      ...
      function () {
        ...
        assert.strictEqual(
          expression.toString(),
          `import { BaseInfernoComponent, InfernoComponent, InfernoComponentWrapper } from "../modules/inferno/base_component"`
        );
      }
    );
    ...
    mocha.it(
      ...
      function () {
        ...
        assert.strictEqual(
          expression.toString(),
          `import { BaseInfernoComponent, InfernoComponent, InfernoComponentWrapper } from "devextreme-generator/modules/base_component"`
        );
      }
    );
  });
