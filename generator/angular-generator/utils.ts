...
import { Identifier, Paren, AsExpression } from "../base-generator/expressions/common";
...
export function getExpression(expression: Expression, options?: toStringOptions): Expression {
    ...
    if (
        ...
        expression instanceof AsExpression
    ) {
...
export function getMember(expression: Expression, options?: toStringOptions): Property | Method | undefined {
