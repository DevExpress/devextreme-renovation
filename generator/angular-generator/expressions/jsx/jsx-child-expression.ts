...
import { Paren, Identifier, Call } from "../../../base-generator/expressions/common";
...
import { Parameter, BaseFunction, getTemplate } from "../../../base-generator/expressions/functions";
...
export class JsxChildExpression extends JsxExpression {
    ...
    compileIterator(iterator: BaseFunction, expression: Call, options?: toStringOptions): string {
