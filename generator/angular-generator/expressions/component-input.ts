...
import { Property as BaseProperty, Method } from "../../base-generator/expressions/class-members";
import { Decorators } from "../../component_declaration/decorators";
import { TypeLiteralNode, extractComplexType, TypeExpression, isTypeArray } from "../../base-generator/expressions/type";
...
import { AngularComponent, compileCoreImports, getAngularSelector } from "./component";
                ...
                if (relatedProp && type instanceof TypeLiteralNode) {
                    const fields = [...type.members].map(m => {
                        const prop = this.createProperty(
                            [this.createDecorator(new Call(new Identifier(Decorators.OneWay), undefined, undefined), {})],
                            undefined,
                            m.name,
                            m.questionToken,
                            m.type,
